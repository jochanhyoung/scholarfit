...
<img src="docs/images/survey_chart.png" alt="설문조사 결과 차트 — 탐색 시간 비교, 시간 단축 체감 점수, 핵심 기능 1순위" width="100%"/>
...
| 지표 | 결과 |
|---|:---:|
| ⚡ **탐색 시간** | **78.9%** 가 스칼라핏으로 `3분 이내` 장학금 발견 |
| ⭐ **시간 단축 체감** | 5점 만점 평균 **4.50점** · 4~5점 응답률 **92.1%** |
| 💡 **가장 도움된 기능** | 프로필 맞춤 필터링 **52.6%** 1위 |
| 🤖 **AI 자소서 활용 의향** | 긍정 응답 **97.4%** (적극 39.5% + 상황 따라 57.9%) |
